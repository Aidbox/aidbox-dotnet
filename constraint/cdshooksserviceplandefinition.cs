...
public class Cdshooksserviceplandefinition : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/cdshooksserviceplandefinition"] };
