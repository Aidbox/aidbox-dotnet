...
public class McodeEcogPerformanceStatus : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-ecog-performance-status"] };
