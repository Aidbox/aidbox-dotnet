...
public class PediatricWeightForHeight : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height"] };
