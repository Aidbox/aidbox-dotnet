...
public class FamilymemberhistoryGenetic : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/familymemberhistory-genetic"] };
