...
public class McodeCancerRelatedMedicationAdministration : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-medication-administration"] };
