...
public class UsCoreMedicationrequest : IResource
{
	public Meta Meta { get; set; } = new() { Profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest"] };
