...
public class Computableplandefinition : DomainResource
{
    public new Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/computableplandefinition"] };
