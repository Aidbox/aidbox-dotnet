...
public class DiagnosticreportGenetics : DomainResource
{
    public new Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/diagnosticreport-genetics"] };
