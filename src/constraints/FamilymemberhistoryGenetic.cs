...
public class FamilymemberhistoryGenetic : DomainResource
{
    public new Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/familymemberhistory-genetic"] };
