...
public class UsCoreSmokingstatus : DomainResource
{
    public new Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus"] };
